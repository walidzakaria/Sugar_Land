Public Class Numbers
    Public Class NumericToLiteral
        ...
        Private Const Hundred = "مائة"
        Private Const TwoHundreds = "مائتان"
        ...
        Private Shared Function Parse(ByVal a As Long, ByVal Female As Boolean, ByVal SingleName As String, ByVal PluralName As String) As String
        ...
        Private Shared Function PluralNames(ByVal Word As String, ByVal unitValue As Long) As String
        ...
        Public Shared Function Convert(ByVal a As Decimal, Optional ByVal Female As Boolean = False, Optional ByVal SingleName As String = "", Optional ByVal PluralName As String = "") As String
            ...
            Dim fractionalPart As String = If(f > 0, Parse(f, Female, SingleName, PluralName), "")

            fractionalPart = fractionalPart.Replace("جنيه", "قرش")
            fractionalPart = fractionalPart.Replace("جنيهات", "قروش")
            fractionalPart = fractionalPart.Replace("قرشات", "قروش")
